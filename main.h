...
static const int64 MAX_MONEY = 105000000 * COIN; // Zecta: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 2.5) / 250; // Zecta: Priority cutoff is 2 Zecta day / 250 bytes.
    }
